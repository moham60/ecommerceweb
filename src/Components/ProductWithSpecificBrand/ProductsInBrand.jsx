...
export default function ProductsInBrand() {
  ...
  return (
    <div className=" min-h-[100vh]  p-4 relative dark:bg-black dark:text-white">
      ...
      <h1 className="text-center   barndtitle relative  w-fit py-3  mx-auto my-10  text-4xl font-bold dark:text-emerald-300 font-serif  rounded p-2">
        {brandName !== undefined
          ? `Product with brand ${brandName}`
          : brandName}
      </h1>
