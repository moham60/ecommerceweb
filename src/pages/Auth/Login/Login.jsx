      ...
      {formLoginGoogle ? (
        ...
        <section className=" py-8    dark:text-white">
          {isloading ? (
            ...
            <div className="flex dark:bg-black w-[90%]  md:w-[50%] lg:w-[35%]  bg-white mx-auto    dark:text-b rounded-lg p-5 flex-col items-center">
        <form
           className="w-full"
          ...
          <button
            ...
            className="text-2xl  dark:text-white text-black hover:underline hover:text-[#0a1179]">
